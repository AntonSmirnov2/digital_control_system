...
#                 dcc.Graph(
#                     id='pie-graph',
#                     figure=distribution_by_status_pie_fig())
#             ], className='pie-graph-card'),
#             #  Graph 2
#             html.Div([
#                 dcc.Graph(
#                     id='bar-graph',
#                     figure=distribution_by_subcontractors_bar_fig())
#             ], className='bar-graph-card')
#         ], style={'width': '74%', 'margin-right': 'auto', 'margin-left': 'auto'})
#     ], className='wrapper'),
# ])

# pie style={'width': '30%', 'display': 'inline-block', 'padding': '0 20'}
# bar style={'width': '49%', 'display': 'inline-block'}
...
#
#
# @dash.callback(Output("progress", "value"), [Input("interval", "n_intervals")])
